...
# execute as: python optimization_hmm.py ./macroscale_state/out 1 28 1-1 ./nanoscale_state ./nanoscale_log
if __name__ == '__main__':
    ...
    time_id = sys.argv[4]
    nanostateloc = sys.argv[5]
    nanologloc = sys.argv[6]
    ...
    # Else produce the job list and return the total number of nodes
        ...
        f = open(nanostateloc+"/out/list_md_jobs.json","w")
        f.write(json)
        f.close()
